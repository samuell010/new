export const animals = [
  ...
  export const insects = [
    ...
    { name: 'European Honey Bee', likes: 0 },
    ...
    { name: 'Cicada', likes: 0 },
    { name: 'Bumblebee', likes: 0 },
    { name: 'Ant', likes: 0 },
    { name: 'Termite', likes: 0 },
    { name: 'Mosquito', likes: 0 },
    { name: 'Beetle', likes: 0 },
    { name: 'Stick Insect', likes: 0 },
    ...
    { name: 'Aphid', likes: 0 },
    { name: 'Earwig', likes: 0 },
    { name: 'Silverfish', likes: 0 },
    { name: 'Mayfly', likes: 0 },
    { name: 'Fruit Fly', likes: 0 },
    { name: 'Lacewing', likes: 0 },
    { name: 'Damselfly', likes: 0 },
    { name: 'Weevil', likes: 0 },
    { name: 'Caterpillar', likes: 0 },
    { name: 'Sawfly', likes: 0 },
    { name: 'Scorpion Fly', likes: 0 },
    { name: 'Dragonfly Nymph', likes: 0 },
    { name: 'Hornet', likes: 0 },
    { name: 'Yellow Jacket', likes: 0 },
    { name: 'Wasp', likes: 0 },
    { name: 'Stink Bug', likes: 0 },
    { name: 'Shield Bug', likes: 0 },
    { name: 'Lady Beetle', likes: 0 },
  ];
  
  export const fish = [
    { name: 'Clownfish', likes: 0 },
    { name: 'Blue Tang', likes: 0 },
    { name: 'Goldfish', likes: 0 },
    { name: 'Koi Carp', likes: 0 },
    ...
    { name: 'Molly', likes: 0 },
    { name: 'Platy', likes: 0 },
    { name: 'Cichlid', likes: 0 },
    { name: 'Rainbowfish', likes: 0 },
    { name: 'Shark', likes: 0 },
    ...
    { name: 'Grouper', likes: 0 },
    { name: 'Herring', likes: 0 },
    { name: 'Mackerel', likes: 0 },
    { name: 'Marlin', likes: 0 },
    { name: 'Snapper', likes: 0 },
    { name: 'Sole', likes: 0 },
    { name: 'Swordfish', likes: 0 },
    { name: 'Tilapia', likes: 0 },
  ];
