      ...
      return (
        <>
          {props.zoo[category]
            ...
            .map((el) => {
              return <Card key={el.name} {...el} category={category} 
              removeCard={() => props.removeCard(el.name, category)} 
              decreaseLikes={() => props.modifyLikes(el.name, "decrease", category)} increaseLikes={() => props.modifyLikes(el.name, "increase", category)} />;
            })}
        </>
      );
    } else {
